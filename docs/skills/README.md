...
本工作區的 `.github/skills/` 目錄包含 **dotnet-testing-agent-skills v2.4.1** 的 Agent Skills 集合。

- [.NET Testing Agent Skills](#net-testing-agent-skills)
  - [簡介](#簡介)
  - [Agent Skills 列表](#agent-skills-列表)
    - [總覽技能（2 個）](#總覽技能2-個)
    - [基礎測試與斷言（10 個）](#基礎測試與斷言10-個)
    - [可測試性抽象化（2 個）](#可測試性抽象化2-個)
    - [測試資料生成（7 個）](#測試資料生成7-個)
    - [整合測試（5 個）](#整合測試5-個)
    - [框架遷移（3 個）](#框架遷移3-個)
    - [第三方 Skill（1 個）](#第三方-skill1-個)
  - [詳細文件](#詳細文件)
  - [版本資訊](#版本資訊)
